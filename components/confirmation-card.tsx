...
export default function ConfirmationCard({ id }: { id: string }) {
  ...
  const waHref = whatsapp ? `https://wa.me/${whatsapp}?text=${encodeURIComponent(`Olá! Não posso comparecer no novo horário do meu atendimento. ID: ${agendamento.id}`)}` : '#';
